[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-2e0aaae1b6195c2367325f4f02e2d04e9abb55f0b24a779b69b11b9e10269abc.svg)](https://classroom.github.com/online_ide?assignment_repo_id=18385907&assignment_repo_type=AssignmentRepo)
# SE_Day1
...
1. Mastering Complexity – Introduced structured programming and OOP to manage growing software complexity.
2. Mastering Process – Developed methodologies like Waterfall and Agile for efficient software development.
3. Mastering Machine – Optimized software for evolving hardware, including cloud and embedded systems.
...
2. Aile Methodology - Iterative and incremental, with multiple cycles (sprints). 
...
Vague Prompt:
"Create a report on software development."

Improved Prompt:
"Write a 2-page report on Agile methodology in software development, covering its principles, benefits, and challenges."

Why it's better:
The improved prompt specifies the topic (Agile methodology), the scope (principles, benefits, challenges), and the length (2 pages), making it clear and actionable.
